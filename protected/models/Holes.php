...
class Holes extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'pictures_fresh_one'=>array(self::HAS_ONE, 'HolePictures', 'hole_id', 'condition'=>'pictures_fresh_one.type="fresh" AND pictures_fresh_one.premoderated=1','order'=>'pictures_fresh_one.ordering'),
