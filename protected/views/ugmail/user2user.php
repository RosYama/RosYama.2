...
<br/>
<p><?php echo CHtml::link('Написать ответ на это письмо можно на страничке '.$this->createUrl('/profile/view', Array('id'=>$fromuser->id)), array('/profile/view', 'id'=>$fromuser->id));?></p>
-----<br/>
