<li<?php if(($index+1)%3==0):?> class="noMargin"<?php endif; ?>>
			<?php echo CHtml::link(CHtml::image($data->STATE == 'fixed' && $data->pictures['small']['fixed'][0] ? $data->pictures['small']['fixed'][0] : $data->pictures['small']['fresh'][0]), array('view', 'id'=>$data->ID), array('class'=>'photo')); ?>			
