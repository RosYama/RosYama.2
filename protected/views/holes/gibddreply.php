...
<?php echo $form->errorSummary($model); ?>
	...
	<div class="lCol">
		...
		<!-- фотки -->
		<div class="f">
			<?php echo $form->labelEx($answer,'files'); ?>
			...
			<?php $this->widget('CMultiFileUpload',array('accept'=>'gif|jpg|png|pdf|txt', 'model'=>$answer, 'attribute'=>'files', 'htmlOptions'=>array('class'=>'mf'), 'denied'=>Yii::t('mf','Невозможно загрузить этот файл'),'duplicate'=>Yii::t('mf','Файл уже существует'),'remove'=>Yii::t('mf','удалить'),'selected'=>Yii::t('mf','Файлы: $file'),)); ?>						
		</div>
