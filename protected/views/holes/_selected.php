...
<?php foreach ($sel->selected_holes_lists as $list) : ?>
	...
	<?php endif; ?>
	<?php if ($list->SentedHolesHasNoAnswer) : ?>
	<?php echo CHtml::link('Загрузить ответ на '.Y::declOfNum(count($list->SentedHolesHasNoAnswer),Array('яму','ямы','ям')), Array('gibddreply','holes'=>implode(',',CHtml::listData($list->SentedHolesHasNoAnswer,'ID','ID'))), Array('class'=>'')); ?><br/>
	<?php endif; ?>
	<?php if ($list->SentedHolesHasAnswer) : ?>
	<?php echo CHtml::link('Загрузить еще ответ на '.Y::declOfNum(count($list->SentedHolesHasAnswer),Array('яму','ямы','ям')), Array('gibddreply','holes'=>implode(',',CHtml::listData($list->SentedHolesHasAnswer,'ID','ID'))), Array('class'=>'')); ?><br/>
	<?php endif; ?>
	<br/>
<?php endforeach; ?>
<?php endif; ?>
