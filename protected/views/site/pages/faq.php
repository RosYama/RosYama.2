...
В последнее время в сети возникает много сайтов, объединяющих людей по волнующим их проблемам. Например <a class="txttohtmllink" href="http://domdvordorogi.ru/">http://domdvordorogi.ru/</a> - по проблемам ЖКХ.</td>
	...
	<table class="faq-item">
		<tr>
			<th>Q:</th>
			<td class="question">Поясните область распространения ГОСТа, на сайте непонятно<br />
			В разделе сайта &quot;Стандарты и нормативы&quot; есть две фразы<br />
...
<br />
Как так получается, что один и тот же ГОСТ действует как на федеральные трассы так и только на проезжую часть дороги?
			</td>
		</tr>		
		<tr>
			<th>A:</th>
