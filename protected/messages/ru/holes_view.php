...
$MESS['HOLE_REQUEST_FORM_SUBMIT3']             = 'Отправить в интернет-приемную';
...
$MESS['HOLE_REQUEST_FORM_SEND_TO_GIBDDRU']            = 'Отправить заявление в Интернет-приемную ГИБДД';
$MESS['HOLE_REQUEST_FORM_SEND_TO_GIBDDRU_COMMENT']            = 'Отметьте, если нужно отправить заявление в интернет-приемную ГИБДД';
